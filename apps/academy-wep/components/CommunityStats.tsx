...
export function CommunityStats({ memberCount }: CommunityStatsProps) {
	return (
		<div className="relative flex justify-center md:justify-end">
			...
			<div className="relative bg-white p-4 sm:p-6 rounded-full shadow-lg border border-gray-100 w-36 h-36 sm:w-40 sm:h-40 md:w-44 md:h-44 lg:w-48 lg:h-48 flex items-center justify-center">
				<div className="relative z-10 flex flex-col items-center">
					...
					<div className="flex flex-col items-center text-center">
						<div className="font-bold text-gray-900 text-2xl">{memberCount}</div>
