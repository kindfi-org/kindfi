...
export function LearningMaterials() {
  ...
  const modules: Module[] = [
    ...
    },
    {
      ...
      description: "Best practices for managing crowdfunded resources on KindFi.",
      lessons: 3,
      completed: 0,
      unlocked: false,
      category: "KindFi",
  ...
  const resources: Resource[] = [
    ...
    },
    {
      ...
      description: "Complete walkthrough of the KindFi platform features and how to use them effectively.",
      type: "video",
      category: "KindFi",
      level: "Beginner",
