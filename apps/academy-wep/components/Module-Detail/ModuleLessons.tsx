...
import { Check, CircleCheckBig, Clock, Play } from "lucide-react";

import { Card, CardContent } from "../base/card";
import { Button } from "../base/button";
import { Lesson } from "../../lib/types/learn/lesson.types";
...
const ModuleLessons: React.FC = () => {
  return (
    <>
      <div className="flex items-center mb-6 p-4 gap-12 ">
        <h2 className="text-2xl font-bold text-gray-900 ">Module Lessons</h2>
        <div className="h-[1px] w-[55rem] bg-gray-200 "></div>
      </div>
