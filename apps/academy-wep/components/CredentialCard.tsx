			...
			<div className="shadow-2xl rounded-md w-full sm:w-4/5 md:w-3/4 lg:w-1/2 mx-auto p-4 sm:p-7">
				<div className="flex flex-col sm:flex-row gap-4 sm:gap-5">
					<div className="mx-auto sm:mx-0 sm:self-center">
						<IoMdRibbon className="shadow-xl p-2 rounded-full text-[#7CC635] text-4xl inline-block h-14 w-14 sm:h-16 sm:w-16" />
					</div>
					<div>
						<h2 className="bg-gradient-to-r from-[#000124] to-[#7CC635] bg-clip-text text-transparent font-bold text-lg sm:text-xl mb-2 sm:mb-3 text-center sm:text-left">
							{title}
						</h2>
						<p className="text-[#4B5563] text-sm sm:text-base text-center sm:text-left">
							{description}
						</p>
