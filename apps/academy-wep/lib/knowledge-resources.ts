...
export const resourcesData: ResourceType[] = [
  {
    ...
    description: "A comprehensive guide to blockchain fundamentals and how they apply to social impact initiatives.",
    category: "Blockchain",
    type: "Article",
  ...
  },
  {
    ...
    description: "Step-by-step video tutorial on creating and securing your Stellar wallet for social impact projects.",
    category: "Stellar",
    type: "Video",
    image: "/placeholder.svg?height=200&width=400",
    duration: 12,
