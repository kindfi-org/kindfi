...
const UploadImage: FC<UploadImageProps> = ({ value, onChange, error, errorMessage }) => {
        ...
        <Box className="w-full mt-8">
            ...
            <Box className="w-full mt-4">
                <TouchableOpacity
                    ...
                    style={[styles.uploadContainer, image ? styles.imageContainer : styles.placeholderContainer]}
                ...
                {error && <Box className=" w-full mt-2" >
                    <Text style={{
                        color: "red"
                    }} className="font-normal text-left text-xs   " >{errorMessage}</Text>
                </Box>}
            </Box>
        </Box>
    );
