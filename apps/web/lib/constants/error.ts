...
export const ERROR_MESSAGES: Record<AuthErrorType, string> = {
    ...
    [AuthErrorType.EMAIL_NOT_CONFIRMED]: 'Please verify your email address before logging in',
    ...
    [AuthErrorType.EXPIRED_CODE]: 'The authentication link has expired. Please request a new one',
    [AuthErrorType.INVALID_CODE]: 'Invalid authentication link. Please request a new one',
    ...
    [AuthErrorType.SERVER_ERROR]: 'An unexpected error occurred. Please try again later'
  }