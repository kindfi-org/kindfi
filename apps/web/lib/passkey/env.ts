...
export const ENV = {
	...
	NETWORK_PASSPHRASE: appConfig.stellar.networkPassphrase,
	FACTORY_CONTRACT_ID: appConfig.stellar.factoryContractId,
	ACCOUNT_SECP256R1_CONTRACT_WASM:
		appConfig.stellar.accountSecp256r1ContractWasm,
	RPC_URL: appConfig.stellar.rpcUrl,
	HORIZON_URL: appConfig.stellar.horizonUrl,
}
