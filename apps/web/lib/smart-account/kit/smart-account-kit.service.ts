...
import { getRpId, getRpName } from './smart-account-kit-config.utils'
import { loadSmartAccountKit } from './smart-account-kit-loader'
...
export interface SmartAccountKitConfig {
	...
	// biome-ignore lint/suspicious/noExplicitAny: StorageAdapter from optional smart-account-kit dynamic import
	storage?: any
}
...
export class SmartAccountKitService {
	// biome-ignore lint/suspicious/noExplicitAny: SmartAccountKit from optional dynamic import
	private kit: any
	...
	private async ensureInitialized(): Promise<void> {
		...
		this.initializationPromise = (async () => {
			...
			try {
				...
				// biome-ignore lint/suspicious/noExplicitAny: kit config shape comes from optional smart-account-kit dynamic import
				const kitConfig: any = {
	 ...
	 */
	// biome-ignore lint/suspicious/noExplicitAny: transaction type from smart-account-kit SDK
