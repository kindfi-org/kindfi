...
export function InviteMemberForm({ onInvite, className }: InviteMemberFormProps) {
						...
						<form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
							...
							<div className="flex justify-end">
								<Button
									type="submit"
									disabled={isSubmitting}
									aria-label={isSubmitting ? 'Sending invitation' : 'Send invitation'}
...
const inviteSchema = z.object({
	...
	role: z.enum(['admin', 'editor', 'advisor', 'community', 'core', 'others'] as const),
