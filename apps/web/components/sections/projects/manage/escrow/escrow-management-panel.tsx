						...
						<Tooltip>
							...
							<TooltipContent className="max-w-xs">
								<div className="space-y-1">
									...
									<p className="font-mono text-xs break-all">{escrowContractAddress}</p>
								</div>
							</TooltipContent>
						</Tooltip>
					</TooltipProvider>
					...
					<CardContent className="pt-6">
						<div className="flex items-center justify-between">
							<div>
								...
								<p className="text-2xl font-bold mt-1">{effectiveEscrowType.replace('-', ' ')}</p>
							</div>
						</div>
					</CardContent>
				</Card>
				...
				<TabsContent value="overview" className="space-y-6">
					{isLoadingEscrow ? (
						<Card>
							<CardContent className="py-12">
								<div className="flex flex-col items-center justify-center space-y-4">
									...
									<p className="text-sm text-muted-foreground">Loading escrow data...</p>
								</div>
							</CardContent>
						</Card>
					) : error ? (
						...
						<>
							...
							{milestones.length > 0 && <MilestonesOverviewCard milestones={milestones} />}
						</>
					) : (
						<Card>
							<CardContent className="py-12">
								<div className="flex flex-col items-center justify-center space-y-4">
									...
									<p className="text-sm text-muted-foreground">No escrow data found</p>
								</div>
							</CardContent>
						</Card>
					)}
