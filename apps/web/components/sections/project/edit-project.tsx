					...
					<div className="flex flex-col gap-5 p-6">
						...
						<div>
							...
							<div className="flex items-center justify-between gap-2 mt-1">
								<p
									className={`${
										taglineValue.length > MAX_LENGTHS.tagline && 'text-red-500'
									} text-[13px]`}
								>
							...
							<div>
								...
								<div className="relative cursor-pointer">
									...
									{fileUrl ? (
										...
										<div
											className={`w-full grid place-items-center border-dashed border-2  rounded-sm h-64 ${
						...
						<div>
							...
							<div className="relative cursor-pointer">
								...
								{videoValue && !errors.video ? (
									...
									<div
										className={`w-full grid place-items-center border-dashed border-2  rounded-sm h-64 ${
											errors.video ? 'border-red-300' : 'border-gray-200'
										}`}
									>
										<div className="flex flex-col items-center gap-4 text-center">
											<div className="grid place-items-center bg-gray-200 w-16 h-16 rounded-full">
