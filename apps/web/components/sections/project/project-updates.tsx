...
import { statsDataUpdates, timelineEvents, successGalleryItems } from "~/mocks/mock-data";

const ProjectUpdatesSection = () => {
  return (
    <SectionContainer>
      <div className="bg-gray-50 rounded-lg p-6 shadow-lg border border-gray-200">
        <h2 className="text-xl font-semibold text-black mb-4">Project Impact</h2>
      ...
      <div className="mt-6 bg-gray-50 rounded-lg p-6 shadow-lg border border-gray-200">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          {successGalleryItems.map((item, index) => (
            <div key={index} className="bg-gray-100 rounded-lg shadow-inner aspect-w-1 aspect-h-1">
              <img
                src={item.src}
                alt={item.alt}
