...
export function ProfileDashboard({ user, defaultTab = 'overview' }: ProfileDashboardProps) {
            ...
            <CardContent className="space-y-4">
                ...
                <form action={onUpdateSlug} className="space-y-2">
                    ...
                    <div className="flex gap-2">
                        <Input id="slug" name="slug" defaultValue={slug} placeholder="your-handle" />
        ...
        <Card>
            ...
            <CardContent className="space-y-3">
                <p className="text-sm text-muted-foreground">
                    Complete KYC to unlock all features and improve trust in the community.
                </p>
