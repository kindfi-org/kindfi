	...
	return (
		<div className="space-y-2 max-h-[400px] overflow-y-auto">
			{donations.map((donation) => {
				...
				const date = donation.contributionDate ? new Date(donation.contributionDate) : null
				const timeAgo = date ? formatDistanceToNow(date, { addSuffix: true }) : 'Recently'
					...
					>
						<div className="flex items-center gap-3 flex-1 min-w-0">
							...
							<div className="flex-1 min-w-0">
								<p className="font-medium text-sm truncate">Donated to {donation.title}</p>
