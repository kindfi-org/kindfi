	...
	return (
		<div className="space-y-6">
			<div className="grid gap-4 grid-cols-1 sm:grid-cols-3">
				<ProfileStatCard label={t('profile.totalCampaigns')} value={String(projectsCount)} />
				<ProfileStatCard label={t('profile.activeCampaigns')} value={String(activeProjectsCount)} />
