...
export function AdminFundingStats({ stats, reducedMotion }: AdminFundingStatsProps) {
	...
	return (
		<div>
			<h2 className="text-2xl font-bold mb-4 text-pretty">Funding Statistics</h2>
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
				<motion.div
					{...motionProps}
					transition={reducedMotion ? { duration: 0 } : { duration: 0.3, delay: 1.0 }}
				>
					<Card>
				...
				<motion.div
					{...motionProps}
					transition={reducedMotion ? { duration: 0 } : { duration: 0.3, delay: 1.05 }}
				>
					<Card>
						<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						...
						<CardContent>
							...
							<p className="text-xs text-muted-foreground mt-1">Combined goals</p>
						</CardContent>
					</Card>
				</motion.div>
				...
				<motion.div
					{...motionProps}
					transition={reducedMotion ? { duration: 0 } : { duration: 0.3, delay: 1.1 }}
				>
					<Card>
						<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
						...
						<CardContent>
							...
							<p className="text-xs text-muted-foreground mt-1">of total target</p>
						</CardContent>
					</Card>
				</motion.div>
				...
				<motion.div
					{...motionProps}
					transition={reducedMotion ? { duration: 0 } : { duration: 0.3, delay: 1.15 }}
				>
					<Card>
						<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
							<CardTitle className="text-sm font-medium">Active Projects Progress</CardTitle>
