...
export function AdminKeyMetrics({ stats }: AdminKeyMetricsProps) {
	return (
		<div>
			<h2 className="text-2xl font-bold mb-4 text-pretty">Key Platform Metrics</h2>
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
				<Card className="border-2 border-green-300 bg-green-100/60">
					<CardHeader className="pb-3">
						<CardTitle className="text-sm font-medium text-green-900">Total Community</CardTitle>
					</CardHeader>
					<CardContent>
						<div className="text-3xl font-bold text-green-900 tabular-nums">{stats.totalUsers}</div>
				...
				<Card className="border-2 border-purple-200 bg-purple-50/50">
					<CardHeader className="pb-3">
						<CardTitle className="text-sm font-medium text-purple-900">Total Raised</CardTitle>
					</CardHeader>
					<CardContent>
				...
				<Card className="border-2 border-orange-200 bg-orange-50/50">
					...
					<CardContent>
						...
						<p className="text-xs text-orange-700 mt-1">{stats.fundedProjects} funded projects</p>
					</CardContent>
				</Card>
			</div>
		</div>
