      ...
      <div className="text-center max-w-2xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-gray-600 mb-8">
            Join forces with passionate Web3 collaborators to create meaningful social and environmental impact.
          </p>
        </motion.div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex-1 relative">
              <Input
                ...
                className={`w-full transition-all duration-300 border-gray-200 focus:border-blue-500 ${isFocused.name ? "ring-2 ring-blue-500/20" : ""
                  }`}
              />
              <motion.div
                initial={false}
            ...
            <div className="flex-1 relative">
              <Input
                ...
                className={`w-full transition-all duration-300 border-gray-200 focus:border-blue-500 ${isFocused.project ? "ring-2 ring-purple-500/20" : ""
                  }`}
              />
              <motion.div
                initial={false}
            ...
            <Button
              ...
              className={`gradient-btn text-white px-8 transition-all duration-300 ${isLoading ? "opacity-80" : ""
                }`}
            >
              {isLoading ? (
        ...
        >
          It takes less than 5 minutes to kick off your journey. Let’s turn your vision into action and impact.
        </motion.p>
      </div>
    </motion.div>
  );
