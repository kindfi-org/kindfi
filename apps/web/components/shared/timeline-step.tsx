...
// Icon configurations
const ICON_CONFIGS = [
	{ bg: 'bg-indigo-100', border: 'border-indigo-200', icon: 'text-indigo-600', line: 'from-green-500 to-blue-500' }, // Project Submission
	{ bg: 'bg-gray-100', border: 'border-gray-200', icon: 'text-gray-600', line: 'from-green-500 to-blue-500' },      // Secure Donations
	{ bg: 'bg-green-100', border: 'border-green-200', icon: 'text-green-600', line: 'from-green-500 to-blue-500' },    // Milestone-Based
	{ bg: 'bg-blue-100', border: 'border-blue-200', icon: 'text-blue-600', line: 'from-green-500 to-blue-500' }        // Community Growth
]
