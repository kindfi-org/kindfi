				...
				<div className="overflow-hidden transition-shadow duration-300 rounded-lg border border-gray-100 bg-white flex hover:shadow-lg">
					...
					<div className="flex-1 p-5">
						...
						<div className="flex justify-between mb-4 text-center">
							...
							<div>
								{/* // !! Naming is wrong... should be kinders... */}
								<p className="font-semibold">{project.donors ?? 0}</p>
...
// ---------------------------------------------------------------------------------------------------
// @andler: I wasn't sure which one to keep, if  the cardContent of the ProjectDetail component.
// I decide to keep the cardContent due it was coming from develop branch, the one that @bran18 worked
// on to connect the project page.
// ---------------------------------------------------------------------------------------------------
