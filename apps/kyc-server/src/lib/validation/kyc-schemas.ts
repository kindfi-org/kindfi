...
export const kycStatusValues = [
	...
	'rejected',
	'verified',
] as const satisfies readonly Database['public']['Enums']['kyc_status_enum'][]

export const kycVerificationLevelValues = [
	'basic',
	'enhanced',
] as const satisfies readonly Database['public']['Enums']['kyc_verification_enum'][]
...
export const kycStatusRecordSchema = z
	.object({
		user_id: z.string().uuid(),
		status: kycStatusSchema,
		verification_level: kycVerificationLevelSchema,
