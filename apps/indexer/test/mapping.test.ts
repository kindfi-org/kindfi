...
const mockEvent = {
  ...
  topic: [
    ...
    xdr.ScVal.scvString('GBYK4I37MZKLL4A2QS7VJCTM5DCNQI2XZWCPM6H4ZHIBMXH3JSTSHZJS'),
    xdr.ScVal.scvString('GDNSSYSCSSJ76FER5WEEXME5G4MTCUBKDRQSKOYP2PQ5TBDSV4XEMJSD')
  ],
    ...
    [
      ...
      },
      {
        ...
        expectedValue: {
          ...
          fromId: 'GBYK4I37MZKLL4A2QS7VJCTM5DCNQI2XZWCPM6H4ZHIBMXH3JSTSHZJS'.toLowerCase(),
