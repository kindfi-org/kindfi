...
export type KycVerification =
	Database['public']['Enums']['kyc_verification_enum']
...
export const isCommentType = (value: unknown): value is CommentType => {
	return (
		typeof value === 'string' &&
		Object.values(COMMENT_TYPE).includes(value as CommentType)
	)
}
...
export const isEscrowStatus = (value: unknown): value is EscrowStatusType => {
	return (
		typeof value === 'string' &&
		Object.values(ESCROW_STATUS).includes(value as EscrowStatusType)
	)
}
...
export const isKycStatus = (value: unknown): value is KycStatus => {
	return (
		typeof value === 'string' &&
		Object.values(KYC_STATUS).includes(value as KycStatus)
	)
}
...
export const isKycVerification = (value: unknown): value is KycVerification => {
	return (
		typeof value === 'string' &&
		Object.values(KYC_VERIFICATION).includes(value as KycVerification)
	)
}
...
export const isMilestoneStatus = (value: unknown): value is MilestoneStatus => {
	return (
		typeof value === 'string' &&
		Object.values(MILESTONE_STATUS).includes(value as MilestoneStatus)
	)
}
...
export const isProjectMemberRole = (
	...
	return (
		typeof value === 'string' &&
		Object.values(PROJECT_MEMBER_ROLE).includes(value as ProjectMemberRole)
	)
}
