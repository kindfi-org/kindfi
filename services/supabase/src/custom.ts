import type { Project, Milestone, EscrowContract, Profile, Category, ProjectMember, Contribution, ProjectUpdate } from './tables'
...
export interface UpdateProjectForm extends Partial<Omit<CreateProjectForm, 'milestones'>> {
  id: string
}
...
export interface UpdateMilestoneForm extends Partial<Omit<CreateMilestoneForm, 'project_id'>> {
  id: string
}
...
export interface UpdateProjectPitchForm extends Partial<Omit<CreateProjectPitchForm, 'project_id'>> {
  id: string
}
